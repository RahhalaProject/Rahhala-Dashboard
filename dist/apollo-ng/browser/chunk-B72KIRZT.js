...
var AuthService = class _AuthService {
  ...
  currentUserSubject = new BehaviorSubject(this.tokenService.getUser());
  currentUser$ = this.currentUserSubject.asObservable();
  isAuthenticated = signal(!!this.tokenService.getAccessToken(), ...ngDevMode ? [{ debugName: "isAuthenticated" }] : []);
  get currentUserValue() {
    return this.currentUserSubject.value;
  }
  login(credentials) {
    return this.http.post(`${this.apiUrl}/v1/AuthenticationManagement/login`, credentials).pipe(tap((response) => this.handleAuthResponse(response)), catchError((error) => {
  ...
  refreshToken() {
    ...
    return this.http.post(`${this.apiUrl}/refresh-token`, request).pipe(tap((response) => this.handleAuthResponse(response)), catchError((error) => {
  ...
  applyProfileToCurrentUser(profile) {
    const u20 = this.currentUserValue;
    if (!u20)
      return;
    const next = __spreadProps(__spreadValues({}, u20), {
      userId: profile.id || u20.userId,
      firstName: profile.firstName,
      lastName: profile.lastName,
      email: profile.email,
      phoneNumber: profile.phoneNumber ?? u20.phoneNumber,
      profilePictureUrl: profile.profilePictureUrl ?? u20.profilePictureUrl,
      address: profile.address ?? u20.address
    });
...
var LanguageService = class _LanguageService {
  ...
  lang = signal(this.readLangFromStorage(), ...ngDevMode ? [{ debugName: "lang" }] : []);
  constructor() {
  ...
  layoutDirection = computed(() => this.lang() === "ar" ? "rtl" : "ltr", ...ngDevMode ? [{ debugName: "layoutDirection" }] : []);
  /** Short code for the toggle label (e.g. AR / EN). */
  currentLangCode = computed(() => this.lang().toUpperCase(), ...ngDevMode ? [{ debugName: "currentLangCode" }] : []);
  toggle() {
  ...
  readLangFromStorage() {
    try {
      const v7 = localStorage.getItem("lang")?.trim();
      return v7 === "en" || v7 === "ar" ? v7 : "ar";
    } catch {
      return "ar";
    }
  }
...
var _c13 = (a0) => ({ "outline outline-primary": a0 });
...
function AppConfigurator_For_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 13);
    \u0275\u0275listener("click", function AppConfigurator_For_10_Template_button_click_0_listener($event) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275styleMap(\u0275\u0275pureFunction1(4, _c03, (primaryColor_r4 == null ? null : primaryColor_r4.name) === "noir" ? "var(--text-color)" : primaryColor_r4 == null ? null : primaryColor_r4.palette == null ? null : primaryColor_r4.palette["500"]));
    \u0275\u0275property("title", primaryColor_r4.name)("ngClass", \u0275\u0275pureFunction1(6, _c13, primaryColor_r4.name === ctx_r1.selectedPrimaryColor()));
  }
}
function AppConfigurator_For_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 14);
    \u0275\u0275listener("click", function AppConfigurator_For_17_Template_button_click_0_listener($event) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275styleMap(\u0275\u0275pureFunction1(4, _c03, surface_r6 == null ? null : surface_r6.palette == null ? null : surface_r6.palette["500"]));
    \u0275\u0275property("title", surface_r6.name)("ngClass", \u0275\u0275pureFunction1(6, _c13, ctx_r1.selectedSurface() ? ctx_r1.selectedSurface() === surface_r6.name : ctx_r1.darkTheme() ? surface_r6.name === "zinc" : surface_r6.name === "slate"));
  }
}
function AppConfigurator_div_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 15)(5, "div", 16)(6, "div", 17)(7, "p-radio-button", 18);
    \u0275\u0275twoWayListener("ngModelChange", function AppConfigurator_div_28_Template_p_radio_button_ngModelChange_7_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.menuMode, $event) || (ctx_r1.menuMode = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function AppConfigurator_div_28_Template_p_radio_button_ngModelChange_7_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setMenuMode("static"));
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 17)(12, "p-radio-button", 20);
    \u0275\u0275twoWayListener("ngModelChange", function AppConfigurator_div_28_Template_p_radio_button_ngModelChange_12_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.menuMode, $event) || (ctx_r1.menuMode = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function AppConfigurator_div_28_Template_p_radio_button_ngModelChange_12_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setMenuMode("overlay"));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "label", 21);
    \u0275\u0275text(14);
    \u0275\u0275pipe(15, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(16, "div", 16)(17, "div", 17)(18, "p-radio-button", 22);
    \u0275\u0275twoWayListener("ngModelChange", function AppConfigurator_div_28_Template_p_radio_button_ngModelChange_18_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.menuMode, $event) || (ctx_r1.menuMode = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function AppConfigurator_div_28_Template_p_radio_button_ngModelChange_18_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setMenuMode("slim"));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "label", 23);
    \u0275\u0275text(20);
    \u0275\u0275pipe(21, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div", 17)(23, "p-radio-button", 24);
    \u0275\u0275twoWayListener("ngModelChange", function AppConfigurator_div_28_Template_p_radio_button_ngModelChange_23_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.menuMode, $event) || (ctx_r1.menuMode = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function AppConfigurator_div_28_Template_p_radio_button_ngModelChange_23_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setMenuMode("slim-plus"));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "label", 25);
    \u0275\u0275text(25);
    \u0275\u0275pipe(26, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(27, "div", 16)(28, "div", 17)(29, "p-radio-button", 26);
    \u0275\u0275twoWayListener("ngModelChange", function AppConfigurator_div_28_Template_p_radio_button_ngModelChange_29_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.menuMode, $event) || (ctx_r1.menuMode = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function AppConfigurator_div_28_Template_p_radio_button_ngModelChange_29_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setMenuMode("reveal"));
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(32, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "div", 17)(34, "p-radio-button", 28);
    \u0275\u0275twoWayListener("ngModelChange", function AppConfigurator_div_28_Template_p_radio_button_ngModelChange_34_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.menuMode, $event) || (ctx_r1.menuMode = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function AppConfigurator_div_28_Template_p_radio_button_ngModelChange_34_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setMenuMode("drawer"));
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(37, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(38, "div", 17)(39, "p-radio-button", 30);
    \u0275\u0275twoWayListener("ngModelChange", function AppConfigurator_div_28_Template_p_radio_button_ngModelChange_39_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.menuMode, $event) || (ctx_r1.menuMode = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function AppConfigurator_div_28_Template_p_radio_button_ngModelChange_39_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setMenuMode("horizontal"));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "label", 31);
    \u0275\u0275text(41);
    \u0275\u0275pipe(42, "translate");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 15, "portal.configurator.menuType"));
    \u0275\u0275advance(5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.menuMode);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(10, 17, "portal.configurator.static"));
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.menuMode);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(15, 19, "portal.configurator.overlay"));
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.menuMode);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(21, 21, "portal.configurator.slim"));
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.menuMode);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(26, 23, "portal.configurator.slimPlus"));
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.menuMode);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(32, 25, "portal.configurator.reveal"));
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.menuMode);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(37, 27, "portal.configurator.drawer"));
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.menuMode);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(42, 29, "portal.configurator.horizontal"));
  }
}
function AppConfigurator_div_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 32)(5, "div", 33)(6, "p-radiobutton", 34);
    \u0275\u0275listener("ngModelChange", function AppConfigurator_div_29_Template_p_radiobutton_ngModelChange_6_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setMenuTheme("colorScheme"));
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 33)(11, "p-radiobutton", 36);
    \u0275\u0275listener("ngModelChange", function AppConfigurator_div_29_Template_p_radiobutton_ngModelChange_11_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setMenuTheme("primaryColor"));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "label", 37);
    \u0275\u0275text(13);
    \u0275\u0275pipe(14, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div", 33)(16, "p-radiobutton", 38);
    \u0275\u0275listener("ngModelChange", function AppConfigurator_div_29_Template_p_radiobutton_ngModelChange_16_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setMenuTheme("transparent"));
    });
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 8, "portal.configurator.menuTheme"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.menuTheme());
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 10, "portal.configurator.menuThemeColorScheme"));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", ctx_r1.menuTheme());
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(14, 12, "portal.configurator.menuThemePrimaryColor"));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", ctx_r1.menuTheme())("disabled", ctx_r1.isTransparentThemeOptionDisabled());
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(19, 14, "portal.configurator.menuThemeTransparent"));
  }
}
var presets = {
  Aura: Qr,
...
var AppConfigurator = class _AppConfigurator {
  ...
  configuratorDrawerPosition = computed(() => this.language.layoutDirection() === "rtl" ? "left" : "right", ...ngDevMode ? [{ debugName: "configuratorDrawerPosition" }] : []);
  router = inject(Router);
  ...
  menuMode = model(this.layoutService.layoutConfig().menuMode, ...ngDevMode ? [{ debugName: "menuMode" }] : []);
  visible = computed(() => this.layoutService.layoutState().configSidebarVisible, ...ngDevMode ? [{ debugName: "visible" }] : []);
  ...
  isTransparentThemeOptionDisabled() {
    ...
    return ["reveal", "overlay", "drawer"].includes(menuMode);
  }
  static \u0275fac = function AppConfigurator_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AppConfigurator)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppConfigurator, selectors: [["app-configurator"]], inputs: { simple: [2, "simple", "simple", booleanAttribute], menuMode: [1, "menuMode"] }, outputs: { menuMode: "menuModeChange" }, decls: 30, vars: 27, consts: [["class", "layout-config-button config-link", "type", "button", 3, "click", 4, "ngIf"], ["styleClass", "layout-config-sidebar w-80", 3, "onHide", "visible", "position", "transitionOptions", "header"], [1, "flex", "flex-col", "gap-4"], [1, "text-lg", "font-semibold"], [1, "pt-2", "flex", "gap-2", "flex-wrap"], ["type", "button", 1, "cursor-pointer", "w-6", "h-6", "rounded-full", "flex", "shrink-0", "items-center", "justify-center", "outline-offset-1", "shadow", 3, "title", "ngClass", "style"], ["type", "button", 1, "cursor-pointer", "w-6", "h-6", "rounded-full", "flex", "shrink-0", "items-center", "justify-center", "p-0", "outline-offset-1", 3, "title", "ngClass", "style"], [1, "flex", "flex-col", "gap-2"], [3, "ngModelChange", "options", "ngModel", "allowEmpty"], ["optionLabel", "name", "optionValue", "value", 3, "ngModelChange", "ngModel", "options", "allowEmpty"], ["class", "flex flex-col gap-2", 4, "ngIf"], ["type", "button", 1, "layout-config-button", "config-link", 3, "click"], [1, "pi", "pi-cog"], ["type", "button", 1, "cursor-pointer", "w-6", "h-6", "rounded-full", "flex", "shrink-0", "items-center", "justify-center", "outline-offset-1", "shadow", 3, "click", "title", "ngClass"], ["type", "button", 1, "cursor-pointer", "w-6", "h-6", "rounded-full", "flex", "shrink-0", "items-center", "justify-center", "p-0", "outline-offset-1", 3, "click", "title", "ngClass"], [1, "flex", "flex-wrap", "flex-col", "gap-3"], [1, "flex"], [1, "flex", "items-center", "gap-2", "w-1/2"], ["name", "menuMode", "value", "static", "inputId", "static", 3, "ngModelChange", "ngModel"], ["for", "static"], ["name", "menuMode", "value", "overlay", "inputId", "overlay", 3, "ngModelChange", "ngModel"], ["for", "overlay"], ["name", "menuMode", "value", "slim", "inputId", "slim", 3, "ngModelChange", "ngModel"], ["for", "slim"], ["name", "menuMode", "value", "slim-plus", "inputId", "slim-plus", 3, "ngModelChange", "ngModel"], ["for", "slim-plus"], ["name", "menuMode", "value", "reveal", "inputId", "reveal", 3, "ngModelChange", "ngModel"], ["for", "reveal"], ["name", "menuMode", "value", "drawer", "inputId", "drawer", 3, "ngModelChange", "ngModel"], ["for", "drawer"], ["name", "menuMode", "value", "horizontal", "inputId", "horizontal", 3, "ngModelChange", "ngModel"], ["for", "horizontal"], [1, "flex", "flex-wrap", "flex-col", "gap-4"], [1, "flex", "items-center", "gap-2"], ["name", "menuTheme", "value", "colorScheme", "inputId", "menutheme-colorscheme", 3, "ngModelChange", "ngModel"], ["for", "menutheme-colorscheme"], ["name", "menuTheme", "value", "primaryColor", "inputId", "menutheme-primarycolor", 3, "ngModelChange", "ngModel"], ["for", "menutheme-primarycolor"], ["name", "menuTheme", "value", "transparent", "inputId", "menutheme-transparent", 3, "ngModelChange", "ngModel", "disabled"], ["for", "menutheme-transparent"]], template: function AppConfigurator_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275template(0, AppConfigurator_button_0_Template, 2, 0, "button", 0);
      ...
      \u0275\u0275elementStart(3, "div", 2)(4, "div")(5, "span", 3);
      \u0275\u0275text(6);
      \u0275\u0275pipe(7, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(8, "div", 4);
      \u0275\u0275repeaterCreate(9, AppConfigurator_For_10_Template, 1, 8, "button", 5, _forTrack0);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(11, "div")(12, "span", 3);
      \u0275\u0275text(13);
      \u0275\u0275pipe(14, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(15, "div", 4);
      \u0275\u0275repeaterCreate(16, AppConfigurator_For_17_Template, 1, 8, "button", 6, _forTrack0);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(18, "div", 7)(19, "span", 3);
      \u0275\u0275text(20);
      \u0275\u0275pipe(21, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(22, "p-selectbutton", 8);
      \u0275\u0275listener("ngModelChange", function AppConfigurator_Template_p_selectbutton_ngModelChange_22_listener($event) {
        return ctx.onPresetChange($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(23, "div", 7)(24, "span", 3);
      \u0275\u0275text(25);
      \u0275\u0275pipe(26, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(27, "p-selectbutton", 9);
      \u0275\u0275listener("ngModelChange", function AppConfigurator_Template_p_selectbutton_ngModelChange_27_listener() {
        return ctx.toggleDarkMode();
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275template(28, AppConfigurator_div_28_Template, 43, 31, "div", 10)(29, AppConfigurator_div_29_Template, 20, 16, "div", 10);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275property("ngIf", ctx.simple);
      \u0275\u0275advance();
      \u0275\u0275property("visible", ctx.visible())("position", ctx.configuratorDrawerPosition())("transitionOptions", ".3s cubic-bezier(0, 0, 0.2, 1)")("header", \u0275\u0275pipeBind1(2, 17, "portal.configurator.settings"));
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 19, "portal.configurator.primary"));
      \u0275\u0275advance(3);
      \u0275\u0275repeater(ctx.primaryColors());
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(14, 21, "portal.configurator.surface"));
      \u0275\u0275advance(3);
      \u0275\u0275repeater(ctx.surfaces);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(21, 23, "portal.configurator.presets"));
      \u0275\u0275advance(2);
      \u0275\u0275property("options", ctx.presets)("ngModel", ctx.selectedPreset())("allowEmpty", false);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(26, 25, "portal.configurator.colorScheme"));
      \u0275\u0275advance(2);
      \u0275\u0275property("ngModel", ctx.darkTheme())("options", ctx.themeOptions)("allowEmpty", false);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", !ctx.simple);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", !ctx.simple);
    }
  }, dependencies: [CommonModule, NgClass, NgIf, FormsModule, NgControlStatus, NgModel, SelectButtonModule, SelectButton, DrawerModule, Drawer, ToggleSwitchModule, RadioButtonModule, RadioButton, TranslateModule, TranslatePipe], encapsulation: 2 });
};
(() => {
  ...
  }], menuMode: [{ type: Input, args: [{ isSignal: true, alias: "menuMode", required: false }] }, { type: Output, args: ["menuModeChange"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppConfigurator, { className: "AppConfigurator", filePath: "src/app/layout/components/app.configurator.ts", lineNumber: 169 });
})();
...
//# sourceMappingURL=chunk-B72KIRZT.js.map
