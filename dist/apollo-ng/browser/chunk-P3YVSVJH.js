...
function Login_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 10)(1, "p-message", 21);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
var Login = class _Login {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Login, selectors: [["app-login"]], decls: 25, vars: 15, consts: [["xmlns", "http://www.w3.org/2000/svg", "viewBox", "0 0 1600 800", "preserveAspectRatio", "none", 1, "fixed", "left-0", "top-0", "min-h-screen", "min-w-screen"], ["width", "1600", "height", "800"], ["d", "M478.4 581c3.2 0.8 6.4 1.7 9.5 2.5c196.2 52.5 388.7 133.5 593.5 176.6c174.2 36.6 349.5 29.2 518.6-10.2V0H0v574.9c52.3-17.6 106.5-27.7 161.1-30.9C268.4 537.4 375.7 554.2 478.4 581z"], ["d", "M181.8 259.4c98.2 6 191.9 35.2 281.3 72.1c2.8 1.1 5.5 2.3 8.3 3.4c171 71.6 342.7 158.5 531.3 207.7c198.8 51.8 403.4 40.8 597.3-14.8V0H0v283.2C59 263.6 120.6 255.7 181.8 259.4z"], ["d", "M454.9 86.3C600.7 177 751.6 269.3 924.1 325c208.6 67.4 431.3 60.8 637.9-5.3c12.8-4.1 25.4-8.4 38.1-12.9V0H288.1c56 21.3 108.7 50.6 159.7 82C450.2 83.4 452.5 84.9 454.9 86.3z"], ["d", "M1397.5 154.8c47.2-10.6 93.6-25.3 138.6-43.8c21.7-8.9 43-18.8 63.9-29.5V0H643.4c62.9 41.7 129.7 78.2 202.1 107.4C1020.4 178.1 1214.2 196.1 1397.5 154.8z"], [1, "px-8", "min-h-screen", "flex", "justify-center", "items-center"], [1, "border", "border-surface-200", "dark:border-surface-700", "bg-surface-0", "dark:bg-surface-900", "rounded", "py-16", "px-6", "md:px-16", "z-10", "w-full", "max-w-md"], [1, "mb-6"], [1, "text-surface-900", "dark:text-surface-0", "text-xl", "font-bold", "mb-2"], [1, "mb-4"], [1, "flex", "flex-col", 3, "ngSubmit", "formGroup"], ["for", "email", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2"], [1, "w-full", "mb-4"], [1, "pi", "pi-envelope"], ["id", "email", "type", "email", "pInputText", "", "placeholder", "you@example.com", "formControlName", "email", "autocomplete", "username", 1, "w-full"], ["severity", "error", "size", "small", "variant", "simple", 1, "mb-4"], ["for", "password", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2"], ["id", "password", "formControlName", "password", "styleClass", "w-full mb-4", "inputStyleClass", "w-full", "placeholder", "Password", 3, "toggleMask", "feedback"], ["pButton", "", "pRipple", "", "type", "submit", "label", "Sign in", 1, "w-full", "mt-2", 3, "disabled"], [3, "simple"], ["severity", "error"]], template: function Login_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(10, "Rahhala login");
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(11, Login_Conditional_11_Template, 3, 1, "div", 10);
      ...
      \u0275\u0275text(14, "Email");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(15, "p-iconfield", 13);
      \u0275\u0275element(16, "p-inputicon", 14)(17, "input", 15);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(18, Login_Conditional_18_Template, 2, 0, "p-message", 16);
      \u0275\u0275conditionalCreate(19, Login_Conditional_19_Template, 2, 0, "p-message", 16);
      \u0275\u0275elementStart(20, "label", 17);
      \u0275\u0275text(21, "Password");
      \u0275\u0275elementEnd();
      \u0275\u0275element(22, "p-password", 18)(23, "button", 19);
      \u0275\u0275elementEnd()()();
      \u0275\u0275element(24, "app-configurator", 20);
    }
    if (rf & 2) {
      \u0275\u0275advance();
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional((ctx.email == null ? null : ctx.email.errors == null ? null : ctx.email.errors["required"]) && (ctx.email == null ? null : ctx.email.touched) ? 18 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional((ctx.email == null ? null : ctx.email.errors == null ? null : ctx.email.errors["email"]) && (ctx.email == null ? null : ctx.email.touched) ? 19 : -1);
      \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Login, { className: "Login", filePath: "src/app/pages/auth/login.ts", lineNumber: 119 });
})();
...
//# sourceMappingURL=chunk-P3YVSVJH.js.map
