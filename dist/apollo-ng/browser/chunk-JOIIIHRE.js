import{c as C}from"./chunk-BODZH67C.js";import{c as ee,d as P,f as b,g as y,h as D}from"./chunk-4O3FVBGX.js";import{d as he}from"./chunk-RT24IGRX.js";import{Ba as pe,Ea as de,Fa as ue,Ga as u,I as E,O as re,P as se,c as te,l as ie,qa as ae,r as oe,ta as le,ua as g,xa as ce,y as ne}from"./chunk-I3WKUYHL.js";import{k as U,n as X,o as G,t as J,x as v}from"./chunk-B6OEZQF5.js";import{$ as c,Fb as Q,Jb as f,Kb as r,La as B,Lb as $,Lc as m,Ma as w,Mb as Y,Mc as K,Nb as S,Pb as x,Qb as L,R as V,Ra as k,S as A,Sa as z,U as H,W as l,Xb as I,aa as p,ab as R,bb as F,eb as Z,ec as W,fb as M,gb as h,gc as q,hc as O,na as _,ob as N,vb as d,wb as T,xb as j}from"./chunk-TAXPTBQK.js";var ve=["content"],be=["*"],ye=(i,s)=>({showTransitionParams:i,hideTransitionParams:s}),ge=(i,s)=>({value:i,params:s}),Ce=i=>({closeCallback:i});function _e(i,s){}function we(i,s){i&1&&h(0,_e,0,0,"ng-template")}function ke(i,s){if(i&1){let e=Q();T(0,"div",1),f("click",function(o){c(e);let n=r();return p(n.onOverlayClick(o))})("@animation.start",function(o){c(e);let n=r();return p(n.onAnimationStart(o))})("@animation.done",function(o){c(e);let n=r();return p(n.onAnimationEnd(o))}),T(1,"div",2),f("click",function(o){c(e);let n=r();return p(n.onContentClick(o))})("mousedown",function(o){c(e);let n=r();return p(n.onContentClick(o))}),Y(2),h(3,we,1,0,null,3),j()()}if(i&2){let e=r();I(e.cn(e.cx("root"),e.styleClass)),d("pBind",e.ptm("root"))("ngStyle",e.style)("@animation",O(16,ge,e.overlayVisible?"open":"close",O(13,ye,e.showTransitionOptions,e.hideTransitionOptions))),N("aria-modal",e.overlayVisible)("aria-label",e.ariaLabel)("aria-labelledBy",e.ariaLabelledBy),w(),I(e.cx("content")),d("pBind",e.ptm("content")),w(2),d("ngTemplateOutlet",e.contentTemplate||e._contentTemplate)("ngTemplateOutletContext",q(19,Ce,e.onCloseClick.bind(e)))}}var Te=`
.p-popover {
